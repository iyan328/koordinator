					...
					<div class="table-responsive">
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
									<?php
										include "koneksi.php";
										$sql = "SELECT * FROM mahasiswa where prodi='$pro'";
										$kueri = mysql_query($sql);
										$no=1;
										$NA=0;
										while($data = mysql_fetch_array($kueri)){
											$nim = $data['nim'];
											$sql1 = "SELECT * FROM nilai_akhir where nim='$nim'";
										...
										$data2 = mysql_fetch_array($kueri2);
												...
												<td><?php echo $data1['nilai_akhir']?></td>
												<?php
												if ($nim2 ==""){
													?>
												<td><a href="tambahnilai.php?kode=<?php echo $data['nim']?>"> Tambah </a> </td>
													<?php
												}
												else {
													?>

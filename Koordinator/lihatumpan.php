...
<?php
	...
	if(isset($_GET['kode'])){
		...
		$sql3 = "SELECT * FROM umpanbalik WHERE nim='$kode'";
				...
				<div class="row">
                    <div class="col-lg-6">
							...
							<div class="form-group">
                                ...
                                <textarea name="kesan" class="form-control" readonly><?php echo $data3['kesan']?></textarea>
                            </div>
							<div class="form-group">
								<label>2. Kendala Ketika Magang</label>
								<textarea name="kendala" class="form-control" readonly><?php echo $data3['kendala']?></textarea>
								<!-- <p class="help-block">Example block-level help text here.</p> -->
                            </div>
							<div class="form-group">
								<label>3. Masukan Bagi Politeknik Negeri Batam</label>
								<textarea name="masukan" class="form-control" readonly><?php echo $data3['masukan']?></textarea>
								<!-- <p class="help-block">Example block-level help text here.</p> -->
                            </div>

...
<?php
	...
	if(isset($_GET['kode'])){
		...
		echo "<script>alert('Mahasiswa Belum Dipilih');document.location='akunmhs.php'</script>";
	}
	$sql2 = "SELECT * FROM mhs WHERE nim='$kode'";
...
<body>
	...
	$user1= $data1['username'];
			...
			if ($kueri){
				...
				echo "<script> alert('Data gagal diubah');document.location='ubahmhs.php'</script>";
				echo mysql_error();
			}
		}
		?>			

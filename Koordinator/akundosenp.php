            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Akun Dosen Pembimbing <small><?php echo $nama?></small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
							...
							<li class="active">
                                <i class="fa fa-user"></i> Akun Dosen Pembimbing
                            </li>
                        </ol>
                    </div>
                </div>
				...
				<form action="" method="post">
					...
					?>
								...
								<td><a href="hapusdp.php?kode=<?php echo $data['username']?>"> Hapus </a> </td>
								</tr>
							<?php
								$no++;}
							?>
...
//		include "koneksi.php";
	//	if (isset($_POST['tambah'])){
		//	echo "<script>document.location='tambahdp.php'</script>";
		//}
		?>